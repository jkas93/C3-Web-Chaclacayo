...
export const LoginPage = () => {
  ...
  const [formVisible] = useState(true); // Para activar la transición de entrada
  const { login } = useAuth();
  ...
  return (
    <div style={{
      ...
      {/* Formulario con animación Headless UI Transition */}
      <Transition
        show={formVisible}
        appear
      ...
      >
        ...
        >
          ...
          {/* Error — con Transition de Headless UI para entrada/salida suave */}
          <Transition
            show={!!error}
          ...
          <div style={{ textAlign: 'center', marginTop: '24px' }}>
            <p style={{ fontSize: '0.75rem', color: 'var(--c3-text-muted)', margin: 0 }}>
              Programa C3 — Chaclacayo &copy; 2026
            </p>
          </div>
        </form>
      </Transition>
