...
export const EmergencyAlertOverlay = () => {
  ...
  // La emergencia más reciente para mostrar info
  ...
  return (
    <>
      {/* Alarma sonora */}
      <audio ref={audioRef} src="/audio/alarm.ogg" loop preload="auto" />

      {/* Overlay parpadeante — con Transition enter/leave */}
      <Transition show={hasActiveEmergency}>
        <div
      ...
      {/* Banner superior con info — con Transition enter/leave */}
      <Transition show={hasActiveEmergency}>
        <div
          style={{
            position: 'fixed',
      ...
      {/* Botón flotante inferior — con Transition enter/leave + delay para efecto escalonado */}
      <Transition show={hasActiveEmergency}>
        <button
          onClick={handleSilenciar}
          style={{
